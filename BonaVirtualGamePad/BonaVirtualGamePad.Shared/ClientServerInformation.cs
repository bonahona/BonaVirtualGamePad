...
namespace BonaVirtualGamePad.Shared
{
    ...
    public class ClientServerInformation
    {
        ...
        {
            return String.Format("Name: {0}, Server: {1}, Port: {2}, Playes; {3}/{4}, Use Password: {5}", ServerName, ServerEndPoint.Address, ServerEndPoint.Port, PlayerCount, Capacity, UsePassword);
        }
    }
}
